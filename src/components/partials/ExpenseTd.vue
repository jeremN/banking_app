<template>
	<tr :key=id :id=id :data-type="item.type">
		<td :class="{ yellow : item.type === 'outcome', green : item.type === 'income' }">
		...
		<td>
			<div class="table__actions">
	            <button 
	            	...
	            	v-if="!editMode">
	                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" x="0px" y="0px" width="12" height="12" viewBox="0 0 25 25" enable-background="new 0 0 25 25" xml:space="preserve">
	                    <defs>
	                    </defs>
	            ...
	            <button 
	            	...
	            	v-if="!editMode">
	                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" x="0px" y="0px" width="12" viewBox="0 0 25 28.6" enable-background="new 0 0 25 28.6" xml:space="preserve">
	                        <defs>
	                        </defs>
	            ...
	            <button 
					...
					<svg version="1.1"
						 ...
						 x="0px" y="0px" width="12" viewBox="0 0 25 25" enable-background="new 0 0 25 25" xml:space="preserve">
						 <defs></defs>
